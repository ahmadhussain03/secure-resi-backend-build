...
class UpdateResidentValidator {
    constructor(ctx) {
        ...
        this.schema = Validator_1.schema.create({
            ...
            'race': Validator_1.schema.enum.optional(['Malay', 'Indian', 'Chinese', 'Other']),
            'religion': Validator_1.schema.enum.optional(['Hindu', 'Buddha', 'Islam', 'Other']),
            ...
            'type': Validator_1.schema.enum.optional(['member', 'resident']),
            'unitId': Validator_1.schema.number.optional([Validator_1.rules.unsigned()])
        });
        this.messages = {
...
exports.default = UpdateResidentValidator;
//# sourceMappingURL=UpdateResidentValidator.js.map