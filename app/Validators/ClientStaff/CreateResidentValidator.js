...
class CreateResidentValidator {
    constructor(ctx) {
        ...
        this.schema = Validator_1.schema.create({
            ...
            'mobileNo': Validator_1.schema.string({ trim: true }, [
                Validator_1.rules.maxLength(255)
            ]),
            ...
            'race': Validator_1.schema.number([Validator_1.rules.unsigned()]),
            'religion': Validator_1.schema.number([Validator_1.rules.unsigned()]),
            ...
            'dob': Validator_1.schema.date({ format: 'yyyy-mm-dd' }),
            'hasCompany': Validator_1.schema.boolean(),
            ...
            'type': Validator_1.schema.enum(['member', 'resident']),
...
exports.default = CreateResidentValidator;
//# sourceMappingURL=CreateResidentValidator.js.map