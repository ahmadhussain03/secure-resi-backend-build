...
class CreateStaffNotificationValidator {
    constructor(ctx) {
        this.ctx = ctx;
        this.schema = Validator_1.schema.create({
            'send_date': Validator_1.schema.date({
                format: 'yyyy-mm-dd'
            }),
...
exports.default = CreateStaffNotificationValidator;
//# sourceMappingURL=CreateStaffNotificationValidator.js.map