...
class CreateLevelValidator {
    constructor(ctx) {
        ...
        this.schema = Validator_1.schema.create({
            ...
            levels: Validator_1.schema.array([Validator_1.rules.minLength(1)]).members(Validator_1.schema.string({ trim: true }, [Validator_1.rules.unique({ table: "levels", column: "name", where: { block_id: this.ctx.request.input('blockId') } })])),
