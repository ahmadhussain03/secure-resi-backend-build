    ...
    constructor(ctx) {
        ...
        this.schema = Validator_1.schema.create({
            ...
            'email': Validator_1.schema.string.optional({ trim: true }, [
                ...
                Validator_1.rules.unique({ table: 'profiles', column: 'email', whereNot: { "user_id": this.ctx.params.id } }),
                Validator_1.rules.maxLength(255)
            ]),
...
exports.default = UpdateOwnerValidator;
//# sourceMappingURL=UpdateOwnerValidator.js.map