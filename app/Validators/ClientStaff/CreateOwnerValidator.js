...
class CreateOwnerValidator {
    constructor(ctx) {
        ...
        this.schema = Validator_1.schema.create({
            ...
            'race': Validator_1.schema.number([Validator_1.rules.exists({ table: 'races', column: 'id' })]),
            'religion': Validator_1.schema.number([Validator_1.rules.exists({ table: 'religions', column: 'id' })]),
...
exports.default = CreateOwnerValidator;
//# sourceMappingURL=CreateOwnerValidator.js.map