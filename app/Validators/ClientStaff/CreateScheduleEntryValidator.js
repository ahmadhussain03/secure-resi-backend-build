...
class CreateScheduleEntryValidator {
    constructor(ctx) {
        this.ctx = ctx;
        this.schema = Validator_1.schema.create({
            ...
            scheduleId: Validator_1.schema.number([Validator_1.rules.unsigned()]),
...
exports.default = CreateScheduleEntryValidator;
//# sourceMappingURL=CreateScheduleEntryValidator.js.map