...
class Item extends Orm_1.BaseModel {
}
__decorate([
...
__decorate([
    (0, Orm_1.column)({
        consume: (image) => image ? `http://${Env_1.default.get('IMAGE_HOST')}/api/staff/upload/guard_item/images/${image}` : null
    }),
