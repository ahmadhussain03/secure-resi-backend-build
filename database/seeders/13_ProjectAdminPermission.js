...
class default_1 extends Seeder_1.default {
    async run() {
        ...
        const permissions = await Permission_1.default.query().select('id').where('type', UserType_1.UserType.client_staff);
        await role.related('permissions').attach(permissions.map(permission => permission.id));
    }
}
exports.default = default_1;
//# sourceMappingURL=13_ProjectAdminPermission.js.map